document.addEventListener('DOMContentLoaded', () => {
  ...
  const faqs = [
    ...
    {
      q: '신청 데이터는 어디에 저장되나요?',
      a: '브라우저 localStorage에만 임시 저장됩니다. 다른 브라우저나 다른 PC에서는 공유되지 않습니다.'
    },
    {
    ...
    },
    {
      ...
      a: '네. 신청 화면에서는 자유롭게 입력할 수 있고, 관리자 화면에서는 끝의 반·번 글자를 제외한 값으로 정규화해 보여줍니다.'
    },
    {
    ...
    },
    {
      ...
      a: '학교 담당자는 자기 학교 건만 빠르게 처리하면 되고, 도교육청 관리자는 지역·학교급·학교명 기준으로 전체 현황을 선별해야 하기 때문입니다.'
    }
  ];
